...
# engine = create_engine("postgresql+psycopg2://mvlab:z1x2c3@46.18.107.104:5432/db1", poolclass=NullPool)# pool_size=20, max_overflow=0,  pool_timeout=300)
...
def createConnection():
    return psycopg2.connect(dbname="db1", user="mvlab",
                                ...
                                # password="z1x2c3", host="46.18.107.104")
